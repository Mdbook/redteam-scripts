...
func unencodedClient() {
	connectPort := GetPortUnencoded()
	if connectPort == "-1" {
		return
	}
	EstablishConnectionUnencoded(connectPort)
}

func GetPortUnencoded() string {
...
func EstablishConnectionUnencoded(port string) {
